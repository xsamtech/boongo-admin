...
return [
    ...
    */
    ...
    // Keys = table "types"."alias"
    'new_user_notif' => ':from_user_names vient de rejoindre la plateforme.',
    'new_event_notif' => ':from_user_names a publie un nouvel evenement.',
    'invited_as_speaker_notif' => ':from_user_names vous a invite comme intervenant.',
    'user_back_notif' => ':from_user_names est de retour sur la plateforme.',
    'event_title_changed_notif' => ':from_user_names a modifie le titre d un evenement.',
    'subscription_notif' => ':from_user_names a souscrit a votre contenu.',
    'work_consultation_notif' => ':from_user_names vient de consulter une de vos oeuvres.',
    'liked_message_notif' => ':from_user_names a aime un de vos messages.',
    'liked_work_notif' => ':from_user_names a aime une de vos oeuvres.',
    'partnership_notif' => ':from_user_names est maintenant votre partenaire.',
    'sponsoring_notif' => ':from_user_names vient de vous sponsoriser.',
    'succeed_payment_notif' => ':from_user_names a effectue un paiement avec succes.',
    'invitation_notif' => ':from_user_names vous a envoye une invitation.',
    'membership_request_notif' => ':from_user_names a envoye une demande d adhesion.',
    'expulsion_notif' => ':from_user_names a ete expulse.',
    'separation_notif' => ':from_user_names a quitte le groupe.',
    'message_in_organization_notif' => ':from_user_names a publie un message dans une organisation.',
];
